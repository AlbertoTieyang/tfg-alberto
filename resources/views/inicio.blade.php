...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1">
        ...
        <div class="container">
            ...
            <div class="row">
                    <div class="col-7">
                        <iframe class="mapa" src="https://www.google.com/maps?q=Palacios%20Cafeter%C3%ADa%20Restaurante%20Federico%20Mayo%2034&output=embed" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"> </iframe>
                    </div>
